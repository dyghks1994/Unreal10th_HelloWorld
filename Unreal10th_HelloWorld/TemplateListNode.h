...
struct TListNode
{
	...
	TListNode* Next = nullptr;		// 링크 부분. 다음 노드의 주소(null이면 이 노드는 Tail)
...
public:
	...
	{
		// InData가 들어간 노드를 만든다
		TListNode<T>* NewNode = new TListNode(InData);
	...
	TListNode<T>* Search(T InData) const
	{
